...
<head>
  ...
  <title>Dashboard - Erporate Employee Attendance System</title>
...
<?php
  ...
  $semuaDataAbsensi = "SELECT * FROM kehadiran";

  $resultKaryawan = mysqli_query($db, $semuaKaryawan);
  $resultJabatan = mysqli_query($db, $semuaJabatan);
  $resultDataAbsensi = mysqli_query($db, $semuaDataAbsensi);
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo mysqli_num_rows($resultJabatan); ?> divisi</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo mysqli_num_rows($resultDataAbsensi); ?> records</div>
                        </div>
                        <div class="col">
